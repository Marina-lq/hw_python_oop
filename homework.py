...
class Running(Training):
    ...
    def get_spent_calories(self) -> float:
        calories = 18 * self.get_mean_speed() - 20
...
class SportsWalking(Training):
    ...
    def get_spent_calories(self) -> float:
        calories_1 = 0.035 * self.weight
        calories_2 = self.get_mean_speed()**2 // self.height
        calories_3 = calories_2 * 0.029 * self.weight
        return (calories_1 + calories_3) * self.duration * 60
